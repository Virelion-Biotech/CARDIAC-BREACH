 ...
 * Deep physiology runs before tactical resolution; no timing-based takeover.
 */
(()=>{
  'use strict';
  ...
  class CardiacApp {
    constructor({core,physiology,documentRef=document}){this.core=core;this.physiology=physiology;this.document=documentRef;this.game=null;this.selectedCell=0;this.started=false;this.listeners=new Set();this.elements={};}
  ...
  const mount=()=>{const app=new CardiacApp({core:CORE,physiology:PHYS});app.mount();window.CBApp=app;document.documentElement.dataset.appReady='true'};
